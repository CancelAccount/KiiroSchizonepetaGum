...
namespace KiiroSchizonepetaGum
{
    ...
    public class HediffCompProperties_VisualEffect : HediffCompProperties
    {
        ...
        /// <summary>粒子生成间隔（tick）。默认 VisualEffectConfig.ParticleIntervalTicksDefault（300 tick ≈ 5 秒）。</summary>
        public int particleIntervalTicks = VisualEffectConfig.ParticleIntervalTicksDefault;
        ...
        public float particleRandomOffsetX = VisualEffectConfig.ParticleRandomOffsetXDefault;

        /// <summary>粒子生成时在 y 轴（高度）方向的随机偏移幅度。
        /// 实际偏移在 [-particleRandomOffsetY, +particleRandomOffsetY] 区间内均匀随机。 </summary>
        public float particleRandomOffsetY = VisualEffectConfig.ParticleRandomOffsetYDefault;

        /// <summary>粒子缩放比例。</summary>
        public float particleScale = VisualEffectConfig.ParticleScaleDefault;
