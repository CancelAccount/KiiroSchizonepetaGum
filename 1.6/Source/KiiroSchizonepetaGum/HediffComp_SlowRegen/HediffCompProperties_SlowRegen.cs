...
namespace KiiroSchizonepetaGum
{
    ...
    {
        /// <summary>每天恢复的 hp 总量。
        /// 与原版 regeneration 语义一致：值=N 表示每天恢复 N hp（默认见 SlowRegenConfig.HealAmountPerDayDefault）。
        /// 计算方式：每 SlowRegenConfig.SlowRegenIntervalTicks tick 触发一次，
        /// 每次治疗量 = N * SlowRegenConfig.RegenHealFactorPerTick，
        /// 每天 60000/15=4000 次，故 N*0.00025*4000 = N hp/天。
        /// </summary>
        public float healAmountPerDay = SlowRegenConfig.HealAmountPerDayDefault;
